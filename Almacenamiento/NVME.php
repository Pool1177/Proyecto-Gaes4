...
$sql = $con->prepare("SELECT id, nombre, precio FROM productos WHERE activo=1 AND id_tipo=8");
$sql->execute();
...
<head>
    ...
    <title>Almacenamiento NVME</title>
        ...
        <nav class="navigation">
            <ul>
                ...
                <li><a href="#">Almacenamiento</a>
                    <ul>
                        <li><a class="SSD" href="SSD.php">Disco SSD <span>12</span></a></li>
                        <li><a class="HDD" href="HDD.php">Disco HDD <span>10</span></a></li>
                        <li><a class="NVME" href="NVME.php">NVME <span>13</span></a></li>
                        <li><a class="USB" href="USB.php">Memorias USB <span>8</span></a></li>
                    </ul>
                </li>
                <li><a href="#">Torres</a>
                    <ul>
