...
$sql = $con->prepare("SELECT id, nombre, precio FROM productos WHERE activo=1 AND id_tipo=5");
$sql->execute();
        ...
        <nav class="navigation">
            <ul>
                ...
                <li><a href="#">Perifericos</a>
                    <ul>
                        <li><a class="Mousse" href="Mouse.php">Mouse <span>25</span></a></li>
                        <li><a class="Teclado" href="Teclado.php">Teclado <span>15</span></a></li>
                        <li><a class="Audifonos" href="Audifonos.php">Audifonos <span>10</span></a></li>
                        <li><a class="Parlantes" href="Parlantes.php">Parlantes Pc <span>5</span></a></li>
                    </ul>
                </li>
