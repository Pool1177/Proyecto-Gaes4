...
$sql = $con->prepare("SELECT id, nombre, precio FROM productos WHERE activo=1 AND id_tipo=17");
$sql->execute();
    ...
    <header class="header">
        ...
        <nav class="navigation">
            <ul>
                ...
                <li><a href="#">Marcas</a>
                    <ul>
                        <li><a href="https://www.logitechg.com/es-roam">Logitech <span>60</span></a></li>
                        <li><a href="https://latam.msi.com/">MSI <span>70</span></a></li>
                        <li><a href="https://www.asrock.com/index.es.asp">ASRock <span>80</span></a></li>
                        <li><a href="https://www.corsair.com/lm/es/">Corsair <span>60</span></a></li>
                        <li><a href="https://www.nvidia.com/es-la/">Nvidia <span>50</span></a></li>
                        <li><a href="https://www.amd.com/es">Amd <span>40</span></a></li>
                        <li><a href="https://www.intel.com/content/www/us/en/homepage.html">Intel <span>40</span></a></li>
                    </ul>
                </li>
            </ul>
        </nav>
